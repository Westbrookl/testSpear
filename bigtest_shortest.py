...
def test_env(env,generated,actor,sess,log=["acpt1","rvnu1","rtio1"],type="static"):
    success=0
    i=0
    ...
    with tf.Session() as sess,open(LOG_FILE + '_master_0', 'w') as log_file:
        ...
        while(epoch<5):
            ...
            if(epoch<=5):
                ...
                master_env=en.Environment("mini", SNODE_SIZE,1000000,imported_graph=[master_graph,node_attr,wmin,wmax],link_embedding_type="shortest",phase="Testing")
                master_env.testing_VNR_list=copy.deepcopy(testing_list)
                
                master_env_2=en.Environment("mini_random", SNODE_SIZE,1000000,imported_graph=[master_graph_2,node_attr,wmin,wmax],link_embedding_type="shortest",phase="Testing")
                master_env_2.testing_VNR_list=copy.deepcopy(testing_list)
                   
                master_env_3=en.Environment("rate_0.08", SNODE_SIZE,1000000,imported_graph=[master_graph_3,node_attr,wmin,wmax],link_embedding_type="shortest",phase="Testing",rate=0.08)
                master_env_3.testing_VNR_list=copy.deepcopy(testing_list_frequent)
                master_env_4=en.Environment("edge_50", SNODE_SIZE,1000000,imported_graph=[master_graph_4,node_attr,wmin,wmax],link_embedding_type="shortest",phase="Testing",VNR_type="edge_v")
                master_env_4.testing_VNR_list=copy.deepcopy(testing_list_edge)
                master_env_5=en.Environment("node_50", SNODE_SIZE,1000000,imported_graph=[master_graph_5,node_attr,wmin,wmax],link_embedding_type="shortest",phase="Testing",VNR_type="node_v")
                master_env_5.testing_VNR_list=copy.deepcopy(testing_list_node)

                master_env_6=en.Environment("all_50", SNODE_SIZE,1000000,imported_graph=[master_graph_6,node_attr,wmin,wmax],link_embedding_type="shortest",phase="Testing",VNR_type="intense")
                master_env_6.testing_VNR_list=copy.deepcopy(testing_list_intense)
                master_env_7=en.Environment("all_100", SNODE_SIZE,1000000,imported_graph=[master_graph_7,node_attr,wmin,wmax],link_embedding_type="shortest",phase="Testing",VNR_type="very_intense")
