...
def test_env(env,generated,actor,sess,log=["acpt","rvnu","rtio"],type="static"):
    x=list()
    #x.append(0)
    y0=list()
    y1=list()
...
def master(network_parameter_queue, exp_queue):
    ...
    testing_list=c_env.generate_VNR_list(3)
    ...
    testing_list_frequent=c_env_3.generate_VNR_list(3)
    ...
    testing_list_edge=c_env_4.generate_VNR_list(3)
    ...
    testing_list_node=c_env_5.generate_VNR_list(3)
    ...
    testing_list_intense=c_env_6.generate_VNR_list(3)
    ...
    testing_list_very_intense=c_env_7.generate_VNR_list(3)
    ...
    testing_list_frequent_1=c_env_3_1.generate_VNR_list(3)
    ...
    testing_list_frequent_2=c_env_3_2.generate_VNR_list(3)
    ...
    testing_list_frequent_3=c_env_3_3.generate_VNR_list(3)
    ...
    testing_list_frequent_4=c_env_3_4.generate_VNR_list(3)
    ...
    testing_list_frequent_5=c_env_3_5.generate_VNR_list(3)
    ...
    testing_list_frequent_6=c_env_3_6.generate_VNR_list(3)
    ...
    testing_list_frequent_7=c_env_3_7.generate_VNR_list(3)
    ...
    testing_list_edge_1=c_env_4_1.generate_VNR_list(2)
    ...
    testing_list_node_1=c_env_5_1.generate_VNR_list(2)
    ...
    testing_list_intense_1=c_env_6_1.generate_VNR_list(2)
    ...
    testing_list_noderank=c_env_noderank.generate_VNR_list(3)
    ...
    with tf.Session() as sess,open(LOG_FILE + '_master_0', 'w') as log_file:
        ...
        while(epoch<5):
            ...
            if(epoch<=5):
                ...
                print("Start Testing:")
                success=test_env(master_env,3,actor,sess)
                success_r=test_env(master_env_2,3,actor,sess,type="random")
                success_f=test_env(master_env_3,3,actor,sess)
                success_e=test_env(master_env_4,3,actor,sess)
                success_n=test_env(master_env_5,3,actor,sess)
                success_i=test_env(master_env_6,3,actor,sess)
                success_f_1 = test_env(master_env_3_1, 3, actor, sess)
                success_f_2 = test_env(master_env_3_2, 3, actor, sess)
                success_f_3 = test_env(master_env_3_3, 3, actor, sess)
                success_f_4 = test_env(master_env_3_4, 3, actor, sess)
                success_f_5 = test_env(master_env_3_5, 3, actor, sess)
                success_f_6 = test_env(master_env_3_6, 3, actor, sess)
                success_f_7 = test_env(master_env_3_7, 3, actor, sess)

                success_e_1 = test_env(master_env_4_1, 3, actor, sess)
                success_n_1 = test_env(master_env_5_1, 3, actor, sess)
                success_i_1 = test_env(master_env_6_1, 3, actor, sess)
                success_vi=test_env(master_env_7,3,actor,sess)
                success_noderank=test_env(master_env_noderank,3,actor,sess)
