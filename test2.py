    ...
    with tf.Session() as sess,open(LOG_FILE + '_master_0', 'w') as log_file:
        ...
        while(epoch<5):
            ...
            if(epoch<=5):
                ...
                master_env_7=en.Environment("Environment_Master", SNODE_SIZE,1000000,imported_graph=[master_graph_7,node_attr,wmin,wmax],link_embedding_type="hybrid",phase="Testing",VNR_type="very_intense")
